...
\NewEntry{puhelin}{+358 (0)40 630 7192\ \ }
% Phone number(s)
...
\NewEntry {Touko 2017--}{Systems Architect, \textsc{Adafy}}
...
\NewEntry{2011--2014}{Jyv\"{a}skyl\"{a}n ammattikorkeakoulu}
...
\Description{\MarginText{Perusteet}\textsc{Functio-ohjelmointi} (Hy,
Clojure, Haskell), web kehitys (Django, Dart)}
...
CM/Synergy, TFS), relaatiokannat (SqlServer, Oracle, SQLite), käyttöliittymät
(WinForms, WPF, PyQt, curses)}

\Description{\MarginText{Asiantuntija}\textsc{Olio-ohjelmointi} (VB.Net, Python,
C\#, Java), testi automaatio (NUnit, JUnit, nose, behave, PyHamcrest,
